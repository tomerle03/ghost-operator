...
import (
	...
	blogv1 "github.com/tomerle03/ghost-operator/api/v1"
...
// +kubebuilder:rbac:groups=blog.leibo.io,resources=ghosts,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=blog.leibo.io,resources=ghosts/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=blog.leibo.io,resources=ghosts/finalizers,verbs=update
//+kubebuilder:rbac:groups=blog.leibo.io,resources=ghosts/events,verbs=get;list;watch;create;update;patch
...
func generateDesiredDeployment(ghost *blogv1.Ghost) *appsv1.Deployment {
	...
	return &appsv1.Deployment{
		ObjectMeta: metav1.ObjectMeta{
			Name:      ghostPrefix + ghost.ObjectMeta.Namespace,
			Namespace: ghost.ObjectMeta.Namespace,
			Labels: map[string]string{
				"app": ghostPrefix + ghost.ObjectMeta.Namespace,
			},
		},
					...
					Containers: []corev1.Container{
						{
							...
							Ports: []corev1.ContainerPort{
								{
									ContainerPort: GhostContainerPort,
								},
							},
							VolumeMounts: []corev1.VolumeMount{
								{
									Name:      ghostPrefix + "-data",
					...
					Volumes: []corev1.Volume{
						{
							...
							VolumeSource: corev1.VolumeSource{
								PersistentVolumeClaim: &corev1.PersistentVolumeClaimVolumeSource{
									ClaimName: pvcNamePrefix + ghost.ObjectMeta.Namespace,
								},
							},
						},
					},
	...
	return &corev1.Service{
		...
		Spec: corev1.ServiceSpec{
			...
			Ports: []corev1.ServicePort{
				{
					Port:       80,
					TargetPort: intstr.FromInt(GhostContainerPort),
					NodePort:   30001,
				},
			},
